...
void QGLViewerWidget::LoadTexture()
{
	...
	//unsigned char* data = stbi_load("../src/Images/tiling patterns/tablecolor.jpg", &width, &height, &nChannels, 0);
	...
	//unsigned char* data = stbi_load("../Images/tiling patterns/sheji1.png", &width, &height, &nChannels, 0);//sheji
